...
Strategy corpus internal integrity: cross-installment contradictions, fact-vs-assumption labeling, promised-but-unapplied corrections. Informs; never gates a deploy.

## Service record

Round 1: three residual labeling/consistency notes on an otherwise verified corpus.
