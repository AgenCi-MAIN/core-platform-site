...
**Standing:** First team, seat 8 — retained on assurance

## Mission

Authorization and capability matrix: ROLE_CAPABILITIES, requireCapability/assertCapability, requireFounder gates, owner peer-protection, deny-by-default on every guarded page and write route. A clean sheet here IS the product.

## Service record

T1: zero findings, honestly — traced every guard, found no bypass. Retained because it audits the crown jewels and cutting it would teach lanes to invent findings.
