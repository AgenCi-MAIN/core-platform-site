...
const STYLES = `
.inbound-grid{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(280px,.85fr);gap:18px;margin-bottom:18px}.inbound-availability-card{border:1px solid var(--portal-line);background:var(--portal-panel);box-shadow:var(--portal-shadow)}.inbound-availability-card:before{content:"";position:absolute;inset:-40% auto auto 55%;width:260px;height:260px;border-radius:50%;background:radial-gradient(circle,rgba(34,197,94,.16),transparent 66%);pointer-events:none}.inbound-availability-card.is-offline:before{background:radial-gradient(circle,var(--portal-line-strong),transparent 66%)}.inbound-availability-kicker{color:var(--portal-muted)}.inbound-live-dot{width:8px;height:8px;border-radius:50%;background:var(--portal-success);box-shadow:0 0 0 5px rgba(34,197,94,.09),0 0 18px rgba(34,197,94,.72)}.is-offline .inbound-live-dot{background:var(--portal-muted);box-shadow:0 0 0 5px rgba(100,116,139,.1)}.inbound-availability-copy>strong{display:block;margin-top:12px;color:var(--portal-text);font-size:clamp(1.45rem,2.5vw,2.2rem);letter-spacing:-.04em}.inbound-availability-copy p{color:var(--portal-muted)}.inbound-availability-copy small{color:var(--portal-muted)}.inbound-availability-actions{position:relative;z-index:1;display:grid;gap:10px;min-width:170px}.inbound-availability-actions button{border:1px solid rgba(52,211,153,.34);border-radius:12px;padding:12px 16px;background:linear-gradient(135deg,var(--portal-success),#0f766e);color:white;font:inherit;font-weight:850;cursor:pointer;box-shadow:0 10px 28px rgba(22,163,74,.2)}.is-available .inbound-availability-actions button{border-color:var(--portal-line-strong);background:var(--portal-raised);color:var(--portal-text);box-shadow:none}.inbound-availability-actions button:disabled{cursor:wait;opacity:.62}.inbound-routing-caveat{font-size:.7rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase;text-align:center;color:var(--portal-warning)}.inbound-save-message{border-top:1px solid var(--portal-line);color:var(--portal-muted)}.inbound-stat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.inbound-stat{border:1px solid var(--portal-line);background:var(--portal-panel);box-shadow:var(--portal-shadow)}.inbound-stat span{color:var(--portal-muted)}.inbound-stat strong{color:var(--portal-text)}.inbound-stat small{color:var(--portal-muted)}.inbound-bridge{border:1px solid color-mix(in srgb,var(--portal-accent) 34%,var(--portal-line));border-radius:var(--portal-radius-xl);padding:22px;background:linear-gradient(145deg,color-mix(in srgb,var(--portal-accent) 12%,transparent),transparent 62%),var(--portal-panel);box-shadow:var(--portal-shadow)}.inbound-bridge-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.inbound-bridge h2{margin:0;color:var(--portal-text);font-size:1.05rem}.inbound-bridge p{margin:8px 0 0;max-width:var(--portal-measure,68ch);color:var(--portal-muted);line-height:1.55;font-size:.87rem}.inbound-bridge-badge{white-space:nowrap;border:1px solid color-mix(in srgb,var(--portal-warning) 45%,transparent);border-radius:999px;padding:6px 9px;color:var(--portal-warning);background:color-mix(in srgb,var(--portal-warning) 12%,var(--portal-panel));font-size:.68rem;font-weight:850;text-transform:uppercase;letter-spacing:.08em}.inbound-flow{display:grid;gap:9px;margin-top:18px}.inbound-flow-row{border-top:1px solid var(--portal-line)}.inbound-flow-row b{background:var(--portal-soft);color:var(--portal-accent-strong)}.inbound-flow-row strong{color:var(--portal-text);font-size:.83rem}.inbound-flow-row small{color:var(--portal-muted);font-size:.72rem}.inbound-feed{overflow:hidden}.inbound-feed-head{display:flex;align-items:end;justify-content:space-between;gap:18px;margin-bottom:16px}.inbound-feed-head h2{margin:0;color:var(--portal-text);font-size:1.15rem}.inbound-feed-head p{margin:5px 0 0;color:var(--portal-muted);font-size:.82rem}.inbound-feed-list{display:grid;gap:8px}.inbound-call{border:1px solid var(--portal-line);background:var(--portal-raised)}.inbound-call strong{color:var(--portal-text);font-size:.9rem}.inbound-call span,.inbound-call small{color:var(--portal-muted);font-size:.76rem}.inbound-call-status{justify-self:end;border:1px solid color-mix(in srgb,var(--portal-accent) 30%,transparent);border-radius:999px;padding:5px 9px;color:var(--portal-accent-strong);background:color-mix(in srgb,var(--portal-accent) 10%,transparent);font-size:.67rem!important;font-weight:800;text-transform:uppercase;letter-spacing:.07em}.inbound-source-note{margin-top:14px;color:var(--portal-muted);font-size:.75rem;line-height:1.5}.inbound-source-note strong{color:var(--portal-text)}@media(max-width:980px){.inbound-grid{grid-template-columns:1fr}.inbound-stat-grid{grid-template-columns:repeat(3,1fr)}}@media(max-width:720px){.inbound-availability-card{grid-template-columns:1fr}.inbound-availability-actions{min-width:0}.inbound-stat-grid{grid-template-columns:1fr}.inbound-call{grid-template-columns:1fr 1fr}.inbound-call-status{justify-self:start}.inbound-feed-head{align-items:flex-start;flex-direction:column}}
`;
