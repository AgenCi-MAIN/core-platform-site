...
const STYLES = `
.leader-source{display:flex;justify-content:space-between;gap:18px;align-items:flex-start;margin-bottom:18px;padding:17px 19px;max-width:var(--portal-measure,68ch);border:1px solid var(--portal-line-strong);border-left:3px solid var(--portal-accent);border-radius:16px;background:var(--portal-panel);color:var(--portal-muted);font-size:.78rem;line-height:1.55}.leader-source strong{color:var(--portal-text)}.leader-source-badge{white-space:nowrap;border:1px dashed var(--portal-line-strong);border-radius:999px;padding:5px 9px;color:var(--portal-muted);background:var(--portal-soft);font-size:.64rem;font-weight:900;letter-spacing:.08em;text-transform:uppercase}.leader-accessible-table{position:absolute!important;width:1px!important;height:1px!important;padding:0!important;margin:-1px!important;overflow:hidden!important;clip:rect(0,0,0,0)!important;white-space:nowrap!important;border:0!important}.leader-podium{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:12px;margin-bottom:18px;align-items:stretch}.leader-card{position:relative;overflow:hidden;min-height:285px;border:1px solid var(--portal-line-strong);border-radius:19px;padding:18px;background:linear-gradient(155deg,rgba(18,27,45,.95),rgba(8,13,24,.93));box-shadow:0 18px 45px rgba(2,6,23,.22);animation:leader-arrive .5s ease both;animation-delay:calc(var(--leader-index) * 70ms)}.leader-card:before{content:"";position:absolute;width:170px;height:170px;border-radius:50%;right:-72px;top:-75px;background:radial-gradient(circle,rgba(56,189,248,.15),transparent 65%);pointer-events:none}.leader-card.rank-1{border-color:color-mix(in srgb,var(--portal-warning) 30%,transparent);transform:translateY(-7px);box-shadow:0 22px 55px rgba(120,78,8,.13),0 18px 45px rgba(2,6,23,.25)}.leader-card.rank-1:before{background:radial-gradient(circle,color-mix(in srgb,var(--portal-warning) 30%,transparent),transparent 65%)}.leader-card.rank-2:before{background:radial-gradient(circle,rgba(203,213,225,.16),transparent 65%)}.leader-card.rank-3:before{background:radial-gradient(circle,rgba(251,146,60,.15),transparent 65%)}@keyframes leader-arrive{from{opacity:0;transform:translateY(14px) scale(.985)}to{opacity:1;transform:translateY(0) scale(1)}}.leader-rank-row{position:relative;z-index:1;display:flex;justify-content:space-between;align-items:center}.leader-rank{display:grid;place-items:center;width:34px;height:34px;border-radius:11px;border:1px solid var(--portal-line-strong);background:var(--portal-soft);color:var(--portal-text);font-size:.8rem;font-weight:900}.rank-1 .leader-rank{color:var(--portal-warning);border-color:color-mix(in srgb,var(--portal-warning) 30%,transparent);background:color-mix(in srgb,var(--portal-warning) 16%,transparent)}.leader-signal{display:flex;align-items:center;gap:6px;color:var(--portal-muted);font-size:.62rem;font-weight:850;letter-spacing:.08em;text-transform:uppercase}.leader-signal:before{content:"";width:6px;height:6px;border-radius:50%;background:var(--portal-success);box-shadow:0 0 12px rgba(34,197,94,.75)}.leader-avatar{position:relative;z-index:1;display:grid;place-items:center;width:54px;height:54px;margin:22px 0 13px;border-radius:17px;border:1px solid rgba(94,234,212,.2);background:linear-gradient(145deg,color-mix(in srgb,var(--portal-accent) 10%,transparent),rgba(30,41,59,.7));color:var(--portal-accent-strong);font-size:1.05rem;font-weight:900}.leader-card h2{position:relative;z-index:1;margin:0;color:var(--portal-text);font-size:1rem;letter-spacing:-.02em}.leader-role{position:relative;z-index:1;display:block;margin-top:4px;color:var(--portal-muted);font-size:.7rem}.leader-card-metrics{position:relative;z-index:1;display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:20px}.leader-metric{border-top:1px solid var(--portal-line-strong);padding-top:10px}.leader-metric span{display:block;color:var(--portal-muted);font-size:.61rem;font-weight:850;letter-spacing:.07em;text-transform:uppercase}.leader-metric strong{display:block;margin-top:4px;color:var(--portal-text);font-size:.95rem}.leader-metric small{display:block;margin-top:3px;color:var(--portal-muted);font-size:.6rem}.leader-next{overflow:hidden}.leader-next-head{display:flex;justify-content:space-between;gap:14px;align-items:end;margin-bottom:14px}.leader-next-head h2{margin:0;color:var(--portal-text);font-size:1.08rem}.leader-next-head p{margin:5px 0 0;color:var(--portal-muted);font-size:.75rem}.leader-next-grid{display:grid;gap:7px}.leader-row{display:grid;grid-template-columns:52px minmax(150px,1.3fr) minmax(100px,.8fr) minmax(90px,.7fr) minmax(115px,.8fr) minmax(85px,.65fr);gap:12px;align-items:center;padding:13px 14px;border:1px solid var(--portal-line-strong);border-radius:13px;background:var(--portal-panel)}.leader-row.header{border:0;background:transparent;padding-top:0;padding-bottom:5px;color:var(--portal-muted);font-size:.61rem;font-weight:850;letter-spacing:.08em;text-transform:uppercase}.leader-row strong{color:var(--portal-text);font-size:.82rem}.leader-row span{color:var(--portal-muted);font-size:.74rem}.leader-pending{color:var(--portal-warning);font-size:.68rem!important}.leader-row-rank{display:grid;place-items:center;width:30px;height:30px;border-radius:9px;background:var(--portal-soft);color:var(--portal-text);font-weight:900}.leader-empty-next{padding:20px;border:1px dashed var(--portal-line-strong);border-radius:14px;background:var(--portal-soft);color:var(--portal-muted);font-size:.8rem}@media(max-width:1120px){.leader-podium{grid-template-columns:repeat(3,1fr)}.leader-card.rank-1{transform:none}}@media(max-width:760px){.leader-podium{grid-template-columns:1fr 1fr}.leader-row{grid-template-columns:44px 1fr 80px}.leader-row>*:nth-child(3),.leader-row>*:nth-child(4),.leader-row>*:nth-child(5){display:none}.leader-source{flex-direction:column}}@media(max-width:520px){.leader-podium{grid-template-columns:1fr}}
`;
